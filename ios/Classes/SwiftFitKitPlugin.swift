...
public class SwiftFitKitPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
    ...
    @available(iOS 9.0, *)
    private func readNewSamples(sampleType: HKSampleType, unit: HKUnit, result: @escaping FlutterResult) {
    ...
    private func readNewSamplesDeprecated(sampleType: HKSampleType, unit: HKUnit, result: @escaping FlutterResult) {
        var anchor = 0
